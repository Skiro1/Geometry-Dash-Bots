# Geometry Dash Mods & Bots List / Список модов и ботов Geometry Dash

---

## Language Navigation / Навигация по языкам

- [🇷🇺 Русский вариант](#-русская-версия-russian-version)
- [🇬🇧 English Variant](#-english-version--английская-версия)
...
| № | Название | Версия | Исходный код | Ссылка / Источник | Цена / Доступ |
| :-: | :--- | :---: | :---: | :--- | :--- |
| 1 | **Silicate** | `v1.1.0` | 🟢 Открытый | [Страница мода](https://geode-sdk.org/mods/peony.silicate) | Бесплатно |
| 2 | **ToastyReplay (Free)** | `v2.2.5` | 🟢 Открытый | [Официальный сайт](https://toastyreplay.xyz/#pricing) | Бесплатно |
...
| 8 | **GucciBot** | `v1.6.4` | 🟢 Открытый | [GitHub Releases](https://github.com/Nigelx1/GucciBot/releases) | Бесплатно |
...
| 15 | **Grape** | `v1.0.1` | 🔒 Закрытый | [Discord Server](https://discord.com/invite/dF8ewrepF) | Доступ через Discord |
| 16 | **iCreatePro** | `v6.10.1` | 🔒 Закрытый | [Официальный сайт](https://icreate.pro/) | **$6.00** |

### Единый маркированный список

1. 🟢 **Silicate** — `v1.1.0` \| [Страница мода](https://geode-sdk.org/mods/peony.silicate) \| *Open Source / Бесплатно*
2. 🟢 **ToastyReplay (Free)** — `v2.2.5` \| [Официальный сайт](https://toastyreplay.xyz/#pricing) \| *Open Source / Бесплатно*
...
8. 🟢 **GucciBot** — `v1.6.4` \| [GitHub Releases](https://github.com/Nigelx1/GucciBot/releases) \| *Open Source / Бесплатно*
9. 🔒 **xdNako** — `v2.7.7` \| [GitHub Releases](https://github.com/CamelliaOffical/XDBot-2.7/releases) \| *Closed Source / Бесплатно*
10. 🔒 **Astral** — `v1.1.0` \| [Open Geode Index](https://open-geode.7m.pl/ui/mod/astralteam.astral-installer) \| *Closed Source / Бесплатно*
...
15. 🔒 **Grape** — `v1.0.1` \| [Discord Server](https://discord.com/invite/dF8ewrepF) \| *Closed Source / Доступ на сервере*
...
| # | Name | Version | Source Code | Link / Source | Price / Access |
| :-: | :--- | :---: | :---: | :--- | :--- |
| 1 | **Silicate** | `v1.1.0` | 🟢 Open Source | [Mod Page](https://geode-sdk.org/mods/peony.silicate) | Free |
| 2 | **ToastyReplay (Free)** | `v2.2.5` | 🟢 Open Source | [Official Website](https://toastyreplay.xyz/#pricing) | Free |
...
| 8 | **GucciBot** | `v1.6.4` | 🟢 Open Source | [GitHub Releases](https://github.com/Nigelx1/GucciBot/releases) | Free |
...
| 15 | **Grape** | `v1.0.1` | 🔒 Closed Source | [Discord Server](https://discord.com/invite/dF8ewrepF) | Server Access Required |
| 16 | **iCreatePro** | `v6.10.1` | 🔒 Closed Source | [Official Website](https://icreate.pro/) | **$6.00** |

### Combined Itemized List

1. 🟢 **Silicate** — `v1.1.0` \| [Mod Page](https://geode-sdk.org/mods/peony.silicate) \| *Open Source / Free*
2. 🟢 **ToastyReplay (Free)** — `v2.2.5` \| [Official Website](https://toastyreplay.xyz/#pricing) \| *Open Source / Free*
...
8. 🟢 **GucciBot** — `v1.6.4` \| [GitHub Releases](https://github.com/Nigelx1/GucciBot/releases) \| *Open Source / Free*
...
15. 🔒 **Grape** — `v1.0.1` \| [Discord Server](https://discord.com/invite/dF8ewrepF) \| *Closed Source / Server Access Required*
